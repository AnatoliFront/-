...
$mail->addAddress('ewdyank@gmail.com');     // Кому будет уходить письмо 
...
$mail->Body    = '' .$name . ' оставил заявку, его телефон ' .$phone. '<br>Почта этого пользователя: ' .$email. '<br>Город: ' .$city;
$mail->AltBody = '';
